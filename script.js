...
//////////////////////////////////////////////////////
// 🔥 دالة الطباعة (معدلة بالكامل بدون قص)
//////////////////////////////////////////////////////

function printReceipt() {

    let customerName = document.getElementById('custName')?.value || 'عميل';
    let phone = document.getElementById('custPhone')?.value || '-';
    let address = document.getElementById('custAddress')?.value || 'غير محدد';
    ...
    cart.forEach(item => {
        ...
        <tr>
            ...
            <td style="width:30%;text-align:left;">${total.toFixed(2)}</td>
        </tr>
        `;
    ...
    td{padding:3px 0; word-wrap:break-word;}
    ...
    <div class="center">
        ...
        <b style="font-size:15px;">سحايب ديرتي</b><br>
    ...
    <div style="font-size:11px;">
        ...
        <div><b>الموعد:</b> ${time}</div>
        <div><b>الموقع:</b> ${address}</div>
    </div>
    ...
    <div>المجموع: ${subtotal.toFixed(2)} ر.س</div>
    ${delivery > 0 ? `<div>التوصيل: ${delivery.toFixed(2)} ر.س</div>` : ''}
    ...
    <div class="center" style="margin-top:10px;">
        <img src="qr.png" style="width:80px;"><br>
